# -*- coding: utf-8 -*-
#
# pypsi documentation build configuration file, created by
...
latex_documents = [
  ('index', 'pypsi.tex', u'pypsi Documentation',
   u'Adam Meily', 'manual'),
]
...
man_pages = [
    ('index', 'pypsi', u'pypsi Documentation',
     [u'Adam Meily'], 1)
]
...
texinfo_documents = [
  ('index', 'pypsi', u'pypsi Documentation',
   u'Adam Meily', 'pypsi', 'One line description of project.',
   'Miscellaneous'),
]
...
def skip(app, what, name, obj, skip, options):
  if name in ('__len__', '__iter__', '__call__', '__getitem__', '__delitem__', '__setitem__'):
    return False
